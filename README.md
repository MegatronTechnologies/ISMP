...
- **Real Edge Incident MVP:** A standalone Windows camera service publishes YOLOv8-annotated MJPEG and turns confirmed bottle detections into authenticated central incidents, notifications, a replayable WebM clip, and annotated snapshots captured every five seconds.
